...
contract PublicParameters {
    ...
    function peddersenBaseG() public view returns (uint256[2] memory point) {
    ...
    function assemblePointsFromEncodings(uint256[m*2] memory _pointsEncoding) internal pure returns(alt_bn128.G1Point[m] memory points) {
    ...
    function assemblePoint(uint256[2] memory _encoding) internal pure returns(alt_bn128.G1Point memory point) {
